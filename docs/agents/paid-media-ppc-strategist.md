---
description: 高级付费媒体策略专家，专注于在Google、Microsoft和Amazon广告平台上进行大规模搜索、购物和性能最大化活动架构设计。设计账户结构、预算分配框架和出价策略，月度支出从10,000美元到100万美元以上。
category: 通用
model: inherit
tools: read, edit
skills: paid-media-ppc-strategist
---
