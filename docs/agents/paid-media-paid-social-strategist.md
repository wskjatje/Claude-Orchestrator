---
description: 跨平台付费社交媒体专家，涵盖Meta（Facebook/Instagram）、LinkedIn、TikTok、Pinterest、X和Snapchat。设计从潜在客户到重定向的全漏斗社交媒体广告计划，采用特定平台的创意和受众策略。
category: 通用
model: inherit
tools: read, edit
skills: paid-media-paid-social-strategist
---
