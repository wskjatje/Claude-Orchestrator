---
description: 涵盖亚马逊、Shopee、Lazada、AliExpress、Temu 和 TikTok Shop 运营、国际物流和海外仓储、合规和税务、多语言列表优化、品牌全球化以及 DTC 独立网站开发的全漏斗跨境电商策略专家。
category: 通用
model: inherit
tools: read, edit
skills: marketing-cross-border-ecommerce
---
