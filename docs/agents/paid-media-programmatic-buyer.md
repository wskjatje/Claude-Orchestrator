---
description: 显示广告和程序化媒体购买专家，涵盖托管位置、Google Display Network、DV360、交易台平台、合作伙伴媒体（新闻通讯、赞助内容）以及通过Demandbase和6Sense等平台的ABM显示策略。
category: 通用
model: inherit
tools: read, edit
skills: paid-media-programmatic-buyer
---
