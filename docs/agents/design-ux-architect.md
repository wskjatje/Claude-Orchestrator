---
description: 技术架构和 UX 专家，为开发人员提供坚实的基础、CSS 系统和清晰的实现指导
category: 通用
model: inherit
tools: read, edit
skills: information-architecture, layout-css-system, ux-structure-spec, html-css-skeleton, frontend-design, web-design-guidelines
---
