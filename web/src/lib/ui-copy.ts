...
export const MSG_MODEL_SETTINGS = "请在「设置 → 模型配置」检查 API 地址、Key 与模型 ID。";

export const LOCAL_ONLY_HINT = "需连接本机服务后可用";

export const DEMO_LIST_BANNER = "示例数据。连接本机后刷新加载。";

export const AGENTS_DISK_SYNC_HINT = "已与 Claude Code Agent 目录同步。";

export const AGENTS_DEMO_HINT = "示例列表。连接本机后刷新加载。";
...
export const MCP_INFO_HINT = "配置在本机，详情内可健康检查。";

export const MCP_EMPTY_BANNER = "尚未配置 MCP。点击「添加」选择模板。";

export const REPORTS_INFO_HINT = "Agent 与任务链执行自动写入。";

export const OVERVIEW_INFO_HINT = "工作区 → 侧栏；模型 → 设置；MCP → MCP 页。";

export const AGENTS_EDITOR_HINT = "右侧编辑；工作流优化可生成修订稿。";

export const SKILLS_EDITOR_HINT = "编辑对应文件即可。";

export const USAGE_SECTION_DESC = "用量汇总。";

export const TODAY_KPIS_DESC = "关键指标。";
...
export const WORKSPACE_HISTORY_HINT = "最近打开的项目文件夹。";
...
export const BROWSER_MODE_CHAT_MESSAGE =
  "请使用 Claude Orchestrator 桌面窗口打开。";

export const WORKSPACE_PANEL_OFFLINE =
  "未连接本机时无法浏览项目文件。请先连接服务。";
...
export const PREVIEW_FILE_HINT = "点击文件查看内容；网页文件可预览。";
